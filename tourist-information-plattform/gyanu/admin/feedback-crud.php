...
<div class="topbar">Feedback Management</div>
...
<td class="action">
<a class="btn btn-del" href="delete-feedback.php?id=<?php echo $row["id"]; ?>" onclick="return confirm('Are you sure you want to delete this feedback?')">Delete</a>
</td>
</tr>
<?php endwhile; ?>
